...
export const MATH_QUESTIONS: Question[] = [
  ...
  // 1. เรขาคณิต - พื้นที่สี่เหลี่ยมคางหมู (แนว มศว.)
  {
    ...
    solution: {
      ...
      trickTip: '💡 วิธีคิดเร็ว: นำผลบวกด้านคู่ขนานคูณความสูงแล้วหารด้วย $2$ ทันที $\implies (8 + 14) \times 6 \div 2 = 22 \times 3 = 66\text{ ตร.ซม.}$',
  ...
  // 3. พีชคณิตและแบบรูป - ลำดับตัวเลขชั้นสูง (แนว มศว.)
  {
    ...
    solution: {
      ...
      trickTip: '💡 ดูผลต่างชั้นที่ 1: $+4, +6, +8, +10, +12 \implies$ ตัวถัดไปต้องบวกด้วย $+14 \implies 43 + 14 = 57$',
  ...
  // 4. โจทย์ปัญหา - กำไร ขาดทุน และการติดราคา (แนว เบ็ญจะมะฯ / มศว.)
  {
    ...
    solution: {
      ...
      trickTip: '💡 สมมติต้นทุน $= 100$ บาทเสมอ: ติดป้าย $140$ บาท ลด $20\%$ คือขาย $80\%$ ของ $140 \implies 140 \times 0.8 = 112\text{ บาท} \implies$ กำไร $112 - 100 = 12\%$',
