    ...
    <div className="space-y-8 pb-16">
      ...
      <div className="space-y-3">
        ...
        <p className="text-slate-600 max-w-2xl leading-relaxed">
          ฝึกจับเวลาจริง มีกระดาษคำตอบดิจิทัลและระบบประเมินผลความพร้อมสอบทันที เพื่อเตรียมความพร้อมสูงสุดสำหรับสนามสอบแข่งขัน รร.ดัง (สวนกุหลาบวิทยาลัย, สตรีวิทยา, ศึกษานารี, ฤทธิยะวรรณาลัย, สารวิทยา, เบ็ญจะมะมหาราช, จุฬาภรณราชวิทยาลัย)
        </p>
      </div>
